...
import { ref } from "vue";
import { useMoviesEpisode } from "./utils/hook";
...
} = useMoviesEpisode(tableRef);
</script>

<template>
  <div v-if="hasAuth('list:MoviesEpisode')" class="main">
    <el-form
      ref="formRef"
      :inline="true"
      :model="form"
    ...
    >
      ...
      <el-form-item :label="t('MoviesEpisode.film')" prop="film_id">
        <el-input
      ...
      <template #buttons>
        <el-space wrap>
          <div v-if="manySelectCount > 0" class="w-[360px]">
            ...
            <el-popconfirm
              v-if="hasAuth('manyDelete:MoviesEpisode')"
              :title="
          ...
          <el-button
            v-if="hasAuth('create:MoviesEpisode') && canAdd"
            type="primary"
      ...
      <template v-slot="{ size, dynamicColumns }">
        ...
        >
          ...
          <template #operation="{ row }">
            ...
            <el-button
              v-if="hasAuth('update:MoviesEpisode')"
              link
              type="primary"
              :size="size"
            ...
            <el-popconfirm
              v-if="hasAuth('delete:MoviesEpisode')"
