...
<template>
  <div v-if="hasAuth('list:systemOperationLog')" class="main">
    ...
    >
      <el-form-item :label="t('logsOperation.userId')" prop="creator_id">
        <el-input
      ...
      <el-form-item :label="t('logsOperation.address')" prop="ipaddress">
        <el-input
      ...
      <el-form-item :label="t('logsOperation.system')" prop="system">
        <el-input
          v-model="form.system"
      ...
      <el-form-item :label="t('logsOperation.browser')" prop="browser">
        <el-input
      ...
      <el-form-item :label="t('logsOperation.requestPath')" prop="path">
        <el-input
          v-model="form.path"
